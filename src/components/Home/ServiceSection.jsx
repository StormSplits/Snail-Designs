...
function Accordion({ content, heading, isOpen, onClick }) {
	return (
		<li onClick={onClick} className="cursor-pointer select-none">
			<div className="font-bold text-2xl md:text-3xl lg:text-4xl flex items-center gap-3">
				{heading}
				<div>
					{isOpen ? (
						<svg
				...
				<div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-10 relative  container">
					<div>
						<h1 className="text-2xl xl:text-3xl max-w-[30ch] leading-snug font-bold mb-4">
							We create impactful digital experiences for leading
							global brands by combining AI, design, and
							technology.
						</h1>
					</div>
					<div>
