...
const Cubes = ({
  ...
  return (
    <div className="md:container mb-10 grid grid-cols-1 md:grid-cols-2 gap-10 md:px-[20px] place-items-center">
  {/* Text Section */}
  ...
  {/* 3D Cube Section */}
  <div
    className="relative md:order-1 w-full aspect-square"
    style={wrapperStyle}
  >
